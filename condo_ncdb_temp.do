...
keep geo2010 - sduni trctpop* shrwht* numhhs* shrblk* ttunit* ttunt* ocunit* ocunt* reunit* reunt* bltto* bltyr* spownoc* sprntoc* bdtot*  ownocc* rntocc* tothsun* vachu*
...
gen minc`y' = avhhin`y'/numhhs`y'
}

**Education Ratios

gen educ_hs1970 = educ127/educpp7
gen educ_hs1980 = educ128/educpp8
gen educ_hs1990 = educ129/educpp9
gen educ_hs2000 = educ120/educpp0
gen educ_hs2010 = educ121a/educpp1a

**Education Ratios

gen educ_b1970 = educ167/educpp7
gen educ_b1980 = educ168/educpp8
gen educ_b1990 = educ169/educpp9
gen educ_b2000 = educ160/educpp0
gen educ_b2010 = educ161a/educpp1a

**Married Ratio

gen marshr1970 = (mcwkid7 + mcnkid7)/numhhs1970
gen marshr1980 = (mcwkid8 + mcnkid8)/numhhs1980
gen marshr1990 = (mcwkid9 + mcnkid9)/numhhs1990
gen marshr2000 = (mcwkid0 + mcnkid0)/numhhs2000
gen marshr2010 = (mcwkid1 + mcnkid1)/numhhs2010
...
keep geo2010 state stusab place cbsa munit* mbed* hu_age* own_* tothu_* vachu_*
...
reshape xij munit1d munit1a munit2_4 munit5pl mbed0 mbed1 mbed2 mbed3 mbed4pl hu_age10_20 hu_age20_30 hu_age30_40 hu_age40pl own tothu vachu
reshape long

destring year, replace force ignore("_")

foreach v of varlist vachu - hu_age40pl {
